...
// jarvis — chatda mijozga javob beradi; qolganlari /post konveyerida ishlaydi.
export const AGENTLAR = ['jarvis', 'qidiruvchi', 'yozuvchi', 'muharrir', 'rasm'];
export const POST_AGENTLARI = ['qidiruvchi', 'yozuvchi', 'muharrir', 'rasm'];
